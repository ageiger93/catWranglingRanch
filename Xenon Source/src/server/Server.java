...
try {
	...
	ex.printStackTrace();
		...
		System.out.println("Launching "+Config.SERVER_NAME+" Coded And created By X");
		 ...
		 */
		System.out.println("X IP: http://mrzeerak8520.wix.com/xenon#!forums/c1c19 With the port: " + serverlistenerPort);
		/**
		 * Main Server Tick
		 */
		try {
	...
	private static void debug() {
		if (debugTimer.elapsed() > 360*1000 || playerExecuted) {
			...
			System.out.println("There are " + PlayerHandler.playerCount+ " Players On Xenon");
			System.out.println("Xe is Running the Egine with: " + debugPercentFormat.format(engineLoad) + "Strain");
			totalCycleTime = 0;
			cycles = 0;
			System.gc();
