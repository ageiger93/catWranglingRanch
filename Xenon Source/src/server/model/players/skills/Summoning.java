...
c.getPA().addSkillXP(1800, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(2300, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(2600, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(2900, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(3200, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(3400, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(3700, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(4100, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(4400, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(4700, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(5700, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(5600, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(9800, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(10100, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(10200, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(10300, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(10400, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(13000, 22); //AmtExp is different so its defined in the method
}
break;
...
c.getPA().addSkillXP(14800, 22); //AmtExp is different so its defined in the method
}
break;
