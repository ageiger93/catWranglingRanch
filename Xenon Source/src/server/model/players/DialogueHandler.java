...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 36899:
			...
			case 185:
                        sendNpcChat4("Hello, im Lottie and i'm in charge of Xenon's Lottery.", "Entering costs 10 million gp but you could win up to", "500 million gp! you can enter up to 2 times per draw.", "Would you like to enter the lottery?", c.talkingNpc, "Lottie");
                        c.nextChat = 186;
                break;
                case 186:
...
/**case 999:
 sendStatement("You must have 25 zombie heads to purchase a fire cape!");
		...
		case 106:
				...
				break;
			case 28:
			sendNpcChat4("@red@XENON", "@cye@X is your owner", "@yel@Staff Spots Open", "@blu@Apply for staff on forums!", c.talkingNpc, "XENON");
			c.nextChat = 0;
			///c.nextChat = 29;
			break;
			case 29:
			...
			case 107:
				...
				break;
                case 70:
				sendNpcChat4("Hello there "+c.playerName+"!", " Welcome to Xenon", "I'm here to tell you the benefits", "Of this server!", c.talkingNpc, "Duke");
				c.nextChat = 71;
				break;
				case 71:
				sendNpcChat4("First of All, the Main owner is X", "He works very hard making the server addictive!", "This is mainly a PvM Server", "There is also Elite Slayer!", c.talkingNpc, "Duke");
				c.nextChat = 72;
				break;
				case 72:
		...
		case 55:
		sendNpcChat4("Hello i am in charage of Xenon SOF", "You must have spins to play my game.",
			"If you do not have spins talk to X", "", c.talkingNpc, "Drawf snowman");
			c.nextChat = 56;
			break;
		case 56:
			...
			case 57:
                ...
                break;
				case 60:
						sendStatement("You have earned 4 Voteing points for voting, Thanks for Voting!");
						c.nextChat = 0;
				break;
				case 30:
