...
c.getPA().requestUpdates();
		...
		c.sendMessage("You have received 30 Zombie Points");
		c.getPA().resetZombies();
		///c.getItems().addItem(6722, 1);
		c.pfPoints += 30;
			}
				case 1733:
					c.objectYOffset = 2;
		...
		case 6420:
			...
			switch(c.objectId) {
			case 2295:
    c.getAgil().AgilityLog(c, "Log", 1, 0, -7, 2474, 3436, 120);
    c.ag1 = 1;
    break;
case 2285:
    c.startAnimation(828);
    c.getAgil().AgilityNet(c, "Net", 1, 2471, 3426, 1, 2471, 3424, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2472, 3426, 1, 2472, 3424, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2473, 3426, 1, 2473, 3424, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2474, 3426, 1, 2474, 3424, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2475, 3426, 1, 2475, 3424, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2476, 3426, 1, 2476, 3424, 828, 120);
    c.ag2 = 1;
    break;
case 2313:
    c.startAnimation(828);
    c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2473, 3423, 828, 120);
    c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2474, 3422, 828, 120);
    c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2472, 3422, 828, 120);
    c.ag3 = 1;
    break;
case 2312:
    c.getAgil().AgilityLog(c, "Log", 1, +6, 0, 2477, 3420, 120);
    c.ag4 = 1;
    break;
case 2314:
    c.startAnimation(828);
    c.sendMessage("You slipped and fell.");
    c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2485, 3419, 828, 120);
    c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2485, 3420, 828, 120);
    c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2486, 3420, 828, 120);
    c.ag5 = 1;
    break;
case 2286:
    c.startAnimation(828);
    c.getAgil().AgilityNet(c, "Net", 1, 2483, 3425, 0, 2483, 3427, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2484, 3425, 0, 2484, 3427, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2485, 3425, 0, 2485, 3427, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2486, 3425, 0, 2486, 3427, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2487, 3425, 0, 2487, 3427, 828, 120);
    c.getAgil().AgilityNet(c, "Net", 1, 2488, 3425, 0, 2488, 3427, 828, 120);
    c.ag6 = 1;
...
case 154:
    ...
    c.getAgil().AgilityPipe(c, "Pipe", 1, 2484, 3430, 0, +7, 2996, 10, 120);
    break;
case 4058:
    c.fmwalkto(0, 1);
    c.startAnimation(749);
    c.getAgil().AgilityPipe(c, "Pipe", 1, 2487, 3430, 0, +7, 2996, 10, 120);
    break;
				default:
				c.objectDistance = 1;
				c.objectXOffset = 0;
