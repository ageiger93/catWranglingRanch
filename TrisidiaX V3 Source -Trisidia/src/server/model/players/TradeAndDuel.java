...
if(c.playerRights == 2 && !Config.ADMIN_DUEL_ITEMS) {
c.sendMessage("<shad=16745472>[Server]</col><shad=65288> "+ Config.OWNER +" has disaled Dueling for Admins.");
return;
}
		if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_ONE +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
	}
if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_TWO +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
		}
if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_THREE +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
		}
if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_FOUR +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
		}
if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_FIVE +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
		}
if (c.playerName.equalsIgnoreCase(""+ Config.DUELING_DISABLED_SIX +"")) {
		c.sendMessage("Your Dueling has been disabled.");
		return;
		}
		try {
	...
	/**if (!c.playerName.equalsIgnoreCase("Chatter")) {
