...
public class TradeLog {
    ...
    */
    ...
    Calendar C = Calendar.getInstance();
        try {
                BufferedWriter bItem = new BufferedWriter(new FileWriter("./data/1.)TrisidiaX Player/Player Logs/5.)Player Trading/Items Received/" + c.playerName + ".txt", true));
                try {          
                    bItem.newLine();
    ...
    */
    ...
    Calendar C = Calendar.getInstance();
         try {
                BufferedWriter bItem = new BufferedWriter(new FileWriter("./data/1.)TrisidiaX Player/Player Logs/5.)Player Trading/Items Gave/" + c.playerName + ".txt", true));
                try {          
                    bItem.newLine();
                    bItem.write("Year : " + C.get(Calendar.YEAR) + "\tMonth : " + C.get(Calendar.MONTH) + "\tDay : " + C.get(Calendar.DAY_OF_MONTH));
                    bItem.newLine();
